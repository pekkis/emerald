...
class EmAdmin_CacheController extends Emerald_Cms_Controller_Action
{
    ...
    public function clearAction()
    {
        ...
        try {
            ...
            $msg = new Emerald_Base_Messaging_Message(Emerald_Base_Messaging_Message::SUCCESS, "All caches were cleared.");
            	
        } catch(Exception $e) {
            $msg = new Emerald_Base_Messaging_Message(Emerald_Base_Messaging_Message::ERROR, "Cleaning the caches failed.");
        }
