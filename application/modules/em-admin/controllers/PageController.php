...
class EmAdmin_PageController extends Emerald_Controller_Action
{
    ...
    public function deleteAction()
    {
        ...
        try {
            ...
            $this->view->message = new Emerald_Messaging_Message(Emerald_Messaging_Message::ERROR, 'Save failed');
        }
    ...
    public function savePartialAction()
    {
        ...
        if($this->_getParam('id')) {
            ...
            if($form->isValidPartial($this->_getAllParams())) {
                ...
                $msg = new Emerald_Messaging_Message(Emerald_Messaging_Message::SUCCESS, 'Ok');

            } else {
                $msg = new Emerald_Messaging_Message(Emerald_Messaging_Message::ERROR, 'Failed');
