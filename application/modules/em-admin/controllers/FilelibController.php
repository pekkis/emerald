...
class EmAdmin_FilelibController extends Emerald_Controller_Action
{
    ...
    public function createFolderAction()
    {
        ...
        if($folderForm->isValid($this->getRequest()->getParams())) {
            ...
            $msg = new Emerald_Messaging_Message(Emerald_Messaging_Message::SUCCESS, 'Folder creation ok.');
            	
        } else {
            $msg = new Emerald_Messaging_Message(Emerald_Messaging_Message::ERROR, 'Folder creation failed.');
