<?php
class EmAdmin_FolderController extends Emerald_Cms_Controller_Action
{
    ...
    public function deleteAction()
    {
        ...
        try {
            ...
            $msg = new Emerald_Base_Messaging_Message(Emerald_Base_Messaging_Message::SUCCESS, 'Folder was deleted.');
        } catch(Exception $e) {
            $msg = new Emerald_Base_Messaging_Message(Emerald_Base_Messaging_Message::ERROR, 'Folder delete failed.');
        }
