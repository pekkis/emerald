<?php
class EmAdmin_FormController extends Emerald_Controller_Action
{
    ...
    public function deleteAction()
    {
        ...
        try {
            $model->delete($item);
            $this->view->message = new Emerald_Messaging_Message(Emerald_Messaging_Message::SUCCESS, 'Delete ok');
        } catch(Emerald_Exception $e) {
            $this->view->message = new Emerald_Messaging_Message(Emerald_Messaging_Message::ERROR, 'Delete failed');
        }
    ...
    public function createPostAction()
    {
        ...
        if($form->isValid($this->_getAllParams())) {
            ...
            $msg = new Emerald_Messaging_Message(Emerald_Messaging_Message::SUCCESS, 'Form was created.');
            $msg->form_id = $item->id;
        } else {
            $msg = new Emerald_Messaging_Message(Emerald_Messaging_Message::ERROR, 'Form creation failed.');
    ...
    public function fieldDeleteAction()
    {
        ...
        try {
            $item = $model->find($this->_getParam('id'));
            $model->delete($item);
            $msg = new Emerald_Messaging_Message(Emerald_Messaging_Message::SUCCESS, 'Field was deleted.');
        } catch(Exception $e) {
            $msg = new Emerald_Messaging_Message(Emerald_Messaging_Message::ERROR, 'Field delete failed.');
        }
        $this->view->message = $msg;
    }
    ...
    public function fieldCreateAction()
    {
        ...
        if($form->isValid($this->_getAllParams())) {
            ...
            $msg = new Emerald_Messaging_Message(Emerald_Messaging_Message::SUCCESS, 'A field was created.');
        } else {
            $msg = new Emerald_Messaging_Message(Emerald_Messaging_Message::ERROR, 'Field creation failed.');
        }
