<?php
class EmAdmin_Form_Folder extends ZendX_JQuery_Form
{
	...
	public function init()
	{
		...
		$this->setAction(EMERALD_URL_BASE . "/em-admin/folder/save");
		...
		$permissionForm = new EmAdmin_Form_FolderPermissions();
