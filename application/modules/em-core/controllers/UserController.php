...
class EmCore_UserController extends Emerald_Cms_Controller_Action
{
    ...
    public function loginAction()
    {
        ...
        if(!$form->isValid($this->getRequest()->getPost())) {
            $msg = new Emerald_Base_Messaging_Message(Emerald_Base_Messaging_Message::ERROR, 'Check fields');
            ...
            if($model->authenticate($form->tussi->getValue(), $form->loso->getValue())) {
                $msg = new Emerald_Base_Messaging_Message(Emerald_Base_Messaging_Message::SUCCESS, 'Login OK');
            } else {
                $msg = new Emerald_Base_Messaging_Message(Emerald_Base_Messaging_Message::ERROR, 'Login failed.');
            }
