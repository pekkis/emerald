    ...
    public function postAction()
    {
        ...
        try {
            ...
            if($zform->isValid($this->getRequest()->getPost())) {
                ...
                $msg = new Emerald_Base_Messaging_Message(Emerald_Base_Messaging_Message::SUCCESS, 'Form was submitted.');
                ...
                $msg = new Emerald_Base_Messaging_Message(Emerald_Base_Messaging_Message::ERROR, 'Form posting failed.');
            ...
            $msg = new Emerald_Base_Messaging_Message(Emerald_Base_Messaging_Message::ERROR, 'Mail send failure.');
