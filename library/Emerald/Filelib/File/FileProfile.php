...
class FileProfile
{
     ...
     *
     * @param \Emerald\Filelib\File\File $fileType File item
     * @return array Array of provided versions
     */
    public function getFileVersions(\Emerald\Filelib\File\File $file)
    {
     ...
     * @return boolean
     */
    public function fileHasVersion(\Emerald\Filelib\File\File $file, $version)
    {
        $filetype = $this->getFilelib()->file()->getType($file);
