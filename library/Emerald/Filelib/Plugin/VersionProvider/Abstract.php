 ...
 *
 */
abstract class Emerald_Filelib_Plugin_VersionProvider_Abstract extends Emerald_Filelib_Plugin_Abstract implements Emerald_Filelib_Plugin_VersionProvider_Interface
{
    /**
